...
describe('adminUserPasswordUpdate', () => {
  test('Test Successful Password Update', () => {
      ...
      let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', 'efgh5678');
  ...
  test('Test Successful: Changing Passwords a bunch of times and checking if it works', () => {
    ...
    let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', 'efgh5678');
    expect(passwordChange).toStrictEqual({});
    passwordChange = adminUserPasswordUpdate(adminId, 'efgh5678', 'password1234');
    expect(passwordChange).toStrictEqual({});
    passwordChange = adminUserPasswordUpdate(adminId, 'password1234', 'fortress9871');
    expect(passwordChange).toStrictEqual({});
    passwordChange = adminUserPasswordUpdate(adminId, 'fortress9871', 'columbus1071');
    expect(passwordChange).toStrictEqual({});
    passwordChange = adminUserPasswordUpdate(adminId, 'columbus1071', 'pirate981');
    expect(passwordChange).toStrictEqual({});
  })
  ...
  test('Test Unsuccessful: Auth User ID invalid', () => {
    ...
    test('Test Unsuccessful: Old Password Incorrect', () => {
      clear();
      let adminId = adminAuthRegister('abcd.efgh@gmail.com', 'abcd1234', 'abcd', 'efgh');
      let passwordChange = adminUserPasswordUpdate(adminId, 'aecd1234', 'efgh5678');
   ...
   test('Test Unsuccessful: Passwords are the Same', () => {
      clear();
      let adminId = adminAuthRegister('abcd.efgh@gmail.com', 'abcd1234', 'abcd', 'efgh');
      let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', 'abcd1234');
    ...
    test('Test Unsuccessful: New Password Matches Old Password', () => {
      ...
      let adminId = adminAuthRegister('abcd.efgh@gmail.com', 'abcd1234', 'abcd', 'efgh');
      let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', 'efgh5678');
      passwordChange = adminUserPasswordUpdate(adminId, 'efgh5678', 'abcd1234');
    ...
    test('Test Unsuccessful: Password less than 8 charachters', () => {
      clear();
      let adminId = adminAuthRegister('abcd.efgh@gmail.com', 'abcd1234', 'abcd', 'efgh');
      let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', 'efgh567');
    ...
    test('Test Unsuccessful: Password does not contain at least one number and at least one letter', () => {
      clear();
      let adminId = adminAuthRegister('abcd.efgh@gmail.com', 'abcd1234', 'abcd', 'efgh');
      let passwordChange = adminUserPasswordUpdate(adminId, 'abcd1234', '***********');
